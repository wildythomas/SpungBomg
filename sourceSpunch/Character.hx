	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				playAnim('danceRight');
			case 'spong':
				tex = Paths.getSparrowAtlas('characters/spong', 'shared');
				frames = tex;
				...
				playAnim('danceRight');
			case 'spong-bob':
				tex = Paths.getSparrowAtlas('characters/character', 'shared');
				frames = tex;
				animation.addByPrefix('singUP', 'spooky UP NOTE', 24, false);
				animation.addByPrefix('singDOWN', 'spooky DOWN note', 24, false);
				animation.addByPrefix('singLEFT', 'note sing left', 24, false);
				...
				playAnim('danceRight');
			case 'pineapple':
				tex = Paths.getSparrowAtlas('characters/papple', 'shared');
				frames = tex;
				animation.addByIndices('danceLeft', 'spooky dance idle instance 1', [0, 2, 6], "", 12, false);
				animation.addByIndices('danceRight', 'spooky dance idle instance 1', [8, 10, 12, 14], "", 12, false);
